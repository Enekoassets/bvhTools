...
def showBvhAnimation(bvhData):
    ...
    while not rl.window_should_close():
        ...
        if(SHOW_UI):
            ...
            rl.gui_check_box(rl.Rectangle(screen_width - 200, 240, 20, 20), "Show Axes", SHOW_AXES)
            rl.gui_check_box(rl.Rectangle(screen_width - 200, 270, 20, 20), "Show Grid", SHOW_GRID)
